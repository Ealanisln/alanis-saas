  ...
  return (
    <div className="mt-28">
      ...
      <div className="flex sm:space-x-4 max-sm:space-y-4 max-sm:flex-col">
        <div className="flex-1 text-xl mt-14 rounded-xl border border-[#4E67E5]/25 bg-gray-300 p-10 w-full">
        ...
        <div
          className="flex-1 text-xl mt-14 rounded-xl border border-[#9966FF]/25 bg-gray-300 p-10 w-full"
        >
        ...
        <div
          className="flex-1 text-xl mt-14 rounded-xl border border-[#F7E16F]/25 bg-gray-300] p-10 w-full"
        >
